<template>
  <el-table
    ...
    <el-table-column label="操作" v-if="treeType === 'normal'" width="460">
...
// 是否默认展开所有树
    ...
    // 点击展开和关闭的时候，图标的切换
      ...
      handleDelete (data,dataType) {
        console.log(data);
        this.$emit('setTableTree', [data.row.categoryTreeNodeId,dataType,data.row.categoryId,data.row.categoryTreeNodeName])
