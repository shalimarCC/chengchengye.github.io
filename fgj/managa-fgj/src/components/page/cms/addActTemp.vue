        ...
        <div class="basicMessage">
            <el-form ref="form" :model="form" label-width="200px">
                ...
                <el-form-item label="模板类型">
                    <el-select v-model="form.type" placeholder="选择模板类型">
                        <el-option
...
import {findCmsElement,insertCmsTemplateWithTx,templateDetail,findCmsElementById} from '../../../api/getData';
export default {
    data(){
       return {
            form:{
    ...
    methods: {
        ...
        async saveActTemp(){
            try{
                ...
                const res = await insertCmsTemplateWithTx(obj);
                if(res.data.code == 0){
                    this.$message({
                        type:"success",
                        message:"模板添加成功"
