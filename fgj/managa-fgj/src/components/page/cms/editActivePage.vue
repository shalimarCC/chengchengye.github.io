        ...
        <template v-if="active==1">
            <el-form ref="form" :model="form" label-width="120px" class="formList">
                ...
                <el-form-item label="所属模板">
                    <el-select class="filter-item" v-model="form.templateId" placeholder="请选择模板" @change="findTemplate(form.templateId)" disabled="disabled">
                        <el-option
                ...
                <div v-if="form.tempFormBasic" v-for="(info,key) in form.tempFormBasic" :key="key">
                    ...
                    <div v-if="titleshow == true">
                        ...
                        <div v-if="imgTitle == true" class="eleIcstyle" style="padding-left: 120px">
                            ...
                            <div v-if="info.id == 16">
                                <cms-link-skip :skipType="form.skipTypeTitle" :skipObj="skipDates"  v-on:getskipDate="getcmsSkipDate"></cms-link-skip>
                            </div>
                        </div>
                    </div>
                    <!-- 导航栏右上角图标 -->
                    <el-form-item v-if="info.id == 20 && info.value == 1">
                        <div class="rightIcon">
                            ...
                            <div v-if="form.iconId1 == 5">
                                <cms-link-skip :skipType="form.linkType1" :skipObjIcon1="skipDates2" v-on:getskipDate="getcmsSkipDateicon1"></cms-link-skip>
                            </div>
                            </p>
                            <p>
                            ...
                            <div v-if="form.iconId2 == 5">
                                <cms-link-skip :skipType="form.linkType2" :skipObjIcon2="skipDates3" v-on:getskipDate="getcmsSkipDateicon2"></cms-link-skip>
                            </div>
                            </p>
                        </div>
                    </el-form-item>
                ...
                <el-form ref="eleConfig" :model="eleConfig" label-width="120px" class="formList">
                        ...
                        <ul v-if="info.elementId == 13 && info.elementSort == eleSort" class="eleUlstyle">
                            ...
                            <li v-if="mesBanner == true" style="overflow:hidden;">
                                <div v-for="(infos,id) in info.config" v-if="infos.type == 8" style="overflow:hidden;">
                                    ...
                                    <!-- 跳转页面 -->
                                    <div v-for="(items,key) in infos.value[0]" v-if="items.skip == 0" style="width:800px;overflow:hidden;">
                                        ...
                                        <el-form-item label="参数1" v-if="items.linkType==1 && (items.linkId == 53 || items.linkId == 85)">
                                            <el-select v-model="items.extParam[0].linkdate1" @change="forceUp">
                                                <el-option
                                                    :key="1"
                                                    label="满减券"
                                                    value="1">
                                        ...
                                        <el-form-item label="配置链接" prop="name" v-else-if="items.linkType==3">
                                            <el-select v-model="items.linkId" @change="forceUp">
                                                <el-option
                                ...
                                <cms-link-skip :skipType="form.skipType" v-on:getskipDate="getcmsSkipDate13"></cms-link-skip>
                            </div> -->
                    ...
                    <div v-for="(info,index) in eleConfig.elementConfig" v-if="eleId == 10 && info.elementSort == eleSort">
                        <ul v-if="info.elementId == 10 && info.elementSort == eleSort" class="eleIcstyle">
                            ...
                            <li>
                                <div v-for="(infos,id) in info.config" style="width:220px;float:left" v-if="infos.group == 88">
                                    <el-form-item v-if="infos.type == 4 && infos.group == 88">
                                        <el-checkbox v-model="infos.value" style="width:80px;" @change="handleCheckicon(infos.id,infos.value)">{{infos.name}}</el-checkbox>
                                    </el-form-item>
                                    <div v-if="iconrowshow==true">
                                ...
                                <div v-if="infos.group == 91 && infos.type == 8" v-for="(items,index) in infos.value" style="overflow:hidden;">
                                    <div v-for="icons in items" style="float:left;">
                                        ...
                                        <el-form-item v-if="icons.type == 7">
                                            <el-select v-model="icons.values[index]" placeholder="请选择跳转配置" @change="checkforce">
                                                <el-option
                                                    v-for="item in bannerSkipList"
                                                    :key="item.value"
                                                    :label="item.key"
                                        ...
                                        <div v-if="icons.skip == 0" style="width:800px;overflow:hidden;">
                                            ...
                                            <el-form-item label="参数1" v-if="icons.values[index]==1 && (icons.linkId[index] == 53 || icons.linkId[index] == 85)">
                                                <el-select v-model="icons.extParam[0].linkdate1[index]" @change="forceUp">
                                                    <el-option
                                                        :key="1"
                                                        label="满减券"
                                                        value="1">
                                            ...
                                            <div v-if="icons.values[index]==8">
                                                ...
                                                <el-form-item label="参数1" v-if="icons.linkId[index] == 9 || icons.linkId[index] == 4">
                                                    <el-select v-model="icons.extParam[0].linkdate1[index]"
                                                               filterable
                                                               reserve-keyword
                                                               placeholder="优惠券批次名称"
                            ...
                            <li v-for="(infos,id) in info.config" >
                                <div v-if="infos.type == 8 && infos.group == 76" v-for="(items,index) in infos.value" style="overflow:hidden;">
                                    <div v-for="icons in items" style="float:left;">
                                        ...
                                        <div v-if="icons.skip == 0" style="width:800px;overflow:hidden;">
                                            <el-form-item label="移动端页面" v-if="icons.values[index] == 4">
                                                <el-select v-model="icons.linkableButtonPageList[0].cmsPageId[index]" placeholder="跳转页面" @focus="getCmsMpage" @change="forceUp">
                                                    <el-option
                                                        v-for="(item,index) in clientTypeDate"
                                                        :key="item.id"
                                                        :label="item.pageName"
                                            ...
                                            <el-form-item label="PC端页面" v-if="icons.values[index] == 4">
                                                <el-select v-model="icons.linkableButtonPageList[1].cmsPageId[index]" placeholder="跳转页面" @focus="getCmsPcpage" @change="forceUp">
                                                    <el-option
                                                        v-for="(item,index) in clientTypeDate"
                                                        :key="item.id"
                                                        :label="item.pageName"
                    ...
                    <div v-for="(info,index) in eleConfig.elementConfig" v-if="eleId == 8 && info.elementSort == eleSort" >
                        <ul v-if="info.elementId == 8 && info.elementSort == eleSort" class="eleUlstyle threeBanner">
                                ...
                                <div v-if="infos.type == 8 && infos.group == 61" v-for="(items,index) in infos.value" style="overflow:hidden;">
                                    ...
                                    <div v-for="icons in items" style="float:left;" class="mesbannerStyle">
                                        ...
                                        <el-form-item v-if="icons.type == 4" style="margin-bottom:0;">
                                            <el-checkbox v-model="icons.values[index]" true-label="1" false-label="0" @change="checkforce">{{icons.name}}</el-checkbox>
                                        </el-form-item>
                                        <el-form-item :label="icons.name" v-if="icons.type == 2" style="margin-bottom:10px;">
                                            <el-input v-model="icons.values[index]" style="width:80px;"></el-input>
                                            <span>{{icons.units}}</span>
                                            <span>{{icons.label}}</span>
                                        </el-form-item>
                                        <el-form-item v-if="icons.type == 7">
                                            <el-select v-model="icons.values[index]" placeholder="请选择跳转配置" @change="skipslide">
                                                <el-option
                                                    v-for="item in bannerSkipList"
                                                    :key="item.value"
                                                    :label="item.key"
                                        ...
                                        <div v-if="icons.skip == 0" style="width:800px;overflow:hidden;">
                                            ...
                                            <el-form-item label="配置参数" v-if="icons.values[index]==1">
                                                <el-select v-model="icons.linkId[index]" @change="pageSkipChange">
                                                    <el-option
                                                        v-for="item in pageSkip"
                                                        :key="item.id"
                            ...
                            <li>
                                <div v-for="(infos,id) in info.config" v-if="infos.group == null && infos.type ==3">
                                    <el-form-item :label="infos.name" v-if="info.elementSort == eleSort">
                                        <div>
                                            <ul style="padding-top: 50px;">
                                                <li v-if="infos.checkBannerList && infos.checkBannerList.length>0" class="siderboxIn clear" v-for="(info,key) in infos.checkBannerList">
                                                    <div style="display:inline-block;" class="clearfix">
                                                        ...
                                                        <div style="display:inline-block;margin:0 40px;width:175px;">
                                                            <p v-if="info.name" style="line-height:30px;">{{info.name}}</p>
                        ...
                        <ul v-if="info.elementId == 6 && info.elementSort == eleSort" class="eleIcstyle threeBanner">
                            ...
                            <li>
                                <div v-for="(infos,id) in info.config" v-if="infos.group == null">
                                    ...
                                    <!-- 跳转页面 -->
                                    <div v-if="infos.type == 7 && infos.obj1" style="width:800px;overflow:hidden;">
...
<script>
    ...
    export default {
            ...
            "$route": {
                handler(curVal,oldVal){
                    ...
                    if(str == "/editActivePage"){
                        ...
                        // this.findCmsPageAllByClientType1();
                        // this.findCmsPageAllByClientType2();
                        this.active = 1;
                    }
                },
            }
        ...
        methods: {
            ...
            handleCheckicon(id,value){
                if(id==88 && value ==1){
                    this.iconrowshow = true;
                }else if(id==88 && value==0){
                    this.iconrowshow = false;
                };
            },
            ...
            async findCfgKeyByTemplateId(){
                try{
                    const res = await findCfgKeyByTemplateId({templateId:this.form.templateId,pageId:this.$route.params.id});
                    if(res.data.code == 0){
                        this.form.name = res.data.data.pageName;
                        this.form.companyType = res.data.data.companyType;
                        if(res.data.data.companyId<0){
                            this.allStatus.push(res.data.data.companyId);
                        }else{
                            this.form.companyId = res.data.data.companyId;
                        };
                        this.form.templateId = res.data.data.templateId;
                        ...
                        let that = this;
                        $.each(that.elementConfig,function(key,info){
                            info.companyIds = info.companyIds;
                            $.each(info.basicConfig,function(id,infos){
                                if(infos.type == 5){
                                    infos.value = Number(infos.value);
                                }
                            })
                        });
                        $.each(that.form.tempFormBasic,function(key,info){
                            if(info.value && info.value!=null){
                                if(info.type==4 && info.value == 1){info.value = true;that.titleshow = true;that.checkshow = true}
                                else if(info.id ==23){that.form.iconId2 = Number(info.value);}
                                else if(info.id == 21){that.form.iconId1 = Number(info.value);}
                                else if(info.id == 24){that.form.iconImgUrl1 = info.value;}
                                else if(info.id == 25){that.form.iconImgUrl2 = info.value;}
                                else if(info.id == 26){
                                    that.form.linkType1 = info.value.linkType;
                                    that.skipDates2.linkId =  info.value.linkId;
                                    that.skipDates2.linkUrl =  info.value.linkUrl;
                                    if(info.value.linkableButtonPageList && info.value.linkableButtonPageList.length>0){
                                        that.skipDates2.cmsPagePcId = info.value.linkableButtonPageList[0].cmsPageId;
                                        that.skipDates2.cmsPageMId = info.value.linkableButtonPageList[1].cmsPageId;
                                    }
                                    if( info.value.extParam &&  info.value.extParam.length>0){
                                        that.skipDates2.linkdate1 = info.value.extParam[2].value;
                                        that.skipDates2.linkdate2 = info.value.extParam[1].value;
                                        that.skipDates2.linkdate3 = info.value.extParam[0].value;
                                    }
                                }
                                else if(info.id == 27){
                                    that.form.linkType2 = info.value.linkType;
                                    that.skipDates3.linkId =  info.value.linkId;
                                    that.skipDates3.linkUrl =  info.value.linkUrl;
                                    if(info.value.linkableButtonPageList && info.value.linkableButtonPageList.length>0){
                                        that.skipDates3.cmsPagePcId = info.value.linkableButtonPageList[0].cmsPageId;
                                        that.skipDates3.cmsPageMId = info.value.linkableButtonPageList[1].cmsPageId;
                                    }
                                    if( info.value.extParam &&  info.value.extParam.length>0){
                                        that.skipDates3.linkdate1 = info.value.extParam[2].value;
                                        that.skipDates3.linkdate2 = info.value.extParam[1].value;
                                        that.skipDates3.linkdate3 = info.value.extParam[0].value;
                                    }
                                    console.log(that.skipDates3)
                                }
                                else if(info.type==5){
                                ...
                                else if(info.type==7 && info.id == 16){
                                    that.form.skipTypeTitle = info.value.linkType;
                                    that.skipDates.linkId =  info.value.linkId;
                                    that.skipDates.linkUrl =  info.value.linkUrl;
                                    if(info.value.linkableButtonPageList && info.value.linkableButtonPageList.length>0){
                                        that.skipDates.cmsPagePcId = info.value.linkableButtonPageList[0].cmsPageId;
                                        that.skipDates.cmsPageMId = info.value.linkableButtonPageList[1].cmsPageId;
                                    }
                                    if( info.value.extParam &&  info.value.extParam.length>0){
                                        that.skipDates.linkdate1 = info.value.extParam[2].value;
                                        that.skipDates.linkdate2 = info.value.extParam[1].value;
                                        that.skipDates.linkdate3 = info.value.extParam[0].value;
                                    };
                                    console.log(that.skipDates);
                                }
                            }
                        });
                        $.each(that.eleConfig.elementConfig,function(key,info){
                            if(info.config){
                                $.each(info.config,function(id,infos){
                                    if(infos.type==4 && infos.value == 1){
                                        infos.value = true;
                                        that.mesBanner =true;
                                    }else if(infos.type == 5 && infos.value && infos.value !=null){
                                        infos.value = Number(infos.value);
                                    }else if(infos.type==8){
                                        if(infos.id == 91 || infos.id == 76 || infos.id==61 || infos.id==47){

                                            if(infos.value && infos.value.length>0){
                                                that.slideBannershow = true;
                                                $.each(infos.value,function(i,items){
                                                    $.each(items,function(j,lists){
                                                        that.$set(lists,'values',{});
                                                        lists.values[i]=lists.value;
                                                        ...
                                                        if(lists.type == 7){
                                                            ...
                                                            items.push(obj);
                                                            if(lists.value!=null && lists.value.linkType!=null){
                                                                lists.values[i] = lists.value.linkType;
                                                                obj.values = lists.values;
                                                                obj.linkType[i]=lists.value.linkType;
                                                                obj.linkId[i] = lists.value.linkId;
                                                                obj.linkUrl[i]= lists.value.linkUrl;
                                                                if(lists.value.linkableButtonPageList && lists.value.linkableButtonPageList.length>0){
                                                                    obj.linkableButtonPageList[0].cmsPageId[i] = lists.value.linkableButtonPageList[0].cmsPageId;
                                                                    obj.linkableButtonPageList[1].cmsPageId[i] = lists.value.linkableButtonPageList[1].cmsPageId;
                                                                };
                                                                if(lists.value.extParam && lists.value.extParam.length>0){
                                                                    if(lists.value.extParam[2].value == null){
                                                                        lists.value.extParam[2].value = '';
                                                                        obj.extParam[0].linkdate1[i] = lists.value.extParam[2].value;
                                                                    }else{
                                                                        obj.extParam[0].linkdate1[i] = lists.value.extParam[2].value;
                                                                    };
                                                                    if(lists.value.extParam[1].value == null){
                                                                        lists.value.extParam[1].value = '';
                                                                        obj.extParam[1].linkdate2[i] = lists.value.extParam[1].value;
                                                                    }else{
                                                                        obj.extParam[1].linkdate2[i] = lists.value.extParam[1].value;
                                                                    };
                                                                    if(lists.value.extParam[0].value == null){
                                                                        lists.value.extParam[0].value = '';
                                                                        obj.extParam[2].linkdate3[i] = lists.value.extParam[0].value;
                                                                    }else{
                                                                        obj.extParam[2].linkdate3[i] = lists.value.extParam[0].value;
                                                                    };
                                                                    // obj.extParam[0].linkdate1[i] = lists.value.extParam[2].value;
                                        ...
                                        else if(infos.id == 152 || infos.id == 111 || infos.id == 120 || infos.id == 129){
                                            ...
                                            if(infos.value && infos.value[0].length<7){
                                                infos.value[0].push(obj1);
                                            };

                                            // console.log(infos);
                                            $.each(infos.value[0],function(i,list){
                                                if(list.type == 7 && list.value !=null){
                                                    obj1.linkType = list.value.linkType;
                                                    obj1.linkId =  list.value.linkId;
                                                    obj1.linkUrl =  list.value.linkUrl;
                                                    if(list.value.linkableButtonPageList && list.value.linkableButtonPageList.length>0){
                                                        obj1.linkableButtonPageList = list.value.linkableButtonPageList
                                                    };
                                                    if( list.value.extParam &&  list.value.extParam.length>0){
                                                        obj1.extParam[0].linkdate1 = list.value.extParam[2].value;
                                                        obj1.extParam[1].linkdate2 = list.value.extParam[1].value;
                                                        obj1.extParam[2].linkdate3 = list.value.extParam[0].value;
                                                    };
                                                    list.value = list.value.linkType;
                                                }
                                            });
                                        ...
                                        if(infos.value && infos.value !=null){
                                            $.each(infos.value,function(i,items){
                                                $.each(items,function(j,lists){
                                                    if(lists.type == 4 && lists.value == "1"){lists.value = true;}
                                                })
                                            })
                                        };
                                    }
                                    else if(infos.type ==7 && infos.value!=null && infos.value.linkType!=null){
                                        let obj1 = new Object();
                                        obj1.linkType = "";
                                        obj1.linkId = "";
                                        obj1.linkUrl = "";
                                        ...
                                        obj1.linkId =  infos.value.linkId;
                                        obj1.linkUrl =  infos.value.linkUrl;
                                        if(infos.value.linkableButtonPageList && infos.value.linkableButtonPageList.length>0){
                                            obj1.linkableButtonPageList = infos.value.linkableButtonPageList
                                        };
                                        if( infos.value.extParam &&  infos.value.extParam.length>0){
                                            // obj1.extParam[0].linkdate1 = infos.value.extParam[2].value;
                                            obj1.extParam[0].linkdate1 = parseInt(infos.value.extParam[2].value);
                                            obj1.extParam[1].linkdate2 = parseInt(infos.value.extParam[1].value);
                                            obj1.extParam[2].linkdate3 = parseInt(infos.value.extParam[0].value);
                                        };
                                        infos.value = infos.value.linkType;
                                        //console.log(infos);
                                    }
                                    else if(infos.type == 3 && !infos.checkBannerList){
                                        infos.checkBannerList = [];
                                        if(infos.value && infos.value[0]!=null){
                                            infos.checkBannerList = infos.value;
            ...
            editEleConfig(id,index){
                ...
                let thtf = this;
                // console.log("this.eleConfig.elementConfig",this.eleConfig.elementConfig);
                $.each(thtf.eleConfig.elementConfig,function(id,info){
                    $.each(info.config,function(key,items){
                        if(items.type == 8){
                            if(items.id == 91 || items.id ==76 || items.id == 61 || items.id == 47){
                                ...
                                // if(items.value && items.value.length>0){
                                //     if(items.id == 152 && items.value[0].length<7 && thtf.eleSort == info.elementSort){
                    ...
                    for (let j=0;j<count;j++){
                        $.each(thtf.eleConfig.elementConfig,function(id,info){
                            if(info.elementSort == thtf.eleSort){
                                $.each(info.config,function(key,items){
                                    if(items.type == 8 && items.id == 91 && items.value!=null){
                                        let iconArray = [];
                    ...
                    $.each(info.config,function(key,items){
                        if(items.type == 8 && items.id ==47){
                            ...
                            for (let i=0;i<count;i++){
                                $.each(sloganArray,function(j,list){
                                    if(list.type==7){
                                        // thtf.form.skipslideBanner = list.values;
                                        sloganArray[5].values = list.values;
                                    }
                                });
                                items.value.push(sloganArray);
            ...
            savePage(){
                ...
                $.each(this.eleConfig.elementConfig,function(id,info){
                    $.each(info.config,function(key,items){
                        if(items.value && items.value !=null && items.type !=3){
                                ...
                                if(items.id == 91 || items.id == 76 || items.id==61 || items.id==47){
                                    ...
                                    $.each(iconArray,function(m,iconsArr){
                                        ...
                                        $.each(iconsArr,function(n,icons){
                                            if(icons.cfgKeyType == 4){
                                                if(icons.cfgKeyValue == true){
                                                    icons.cfgKeyValue = 1;
                                                }else if(icons.cfgKeyValue == false || icons.cfgKeyValue==null){
                                                    icons.cfgKeyValue = 0;
                                                }
                                            }
                                        ...
                                        $.each(elesvalue,function(m,eles){
                                            ...
                                            if(eles.parentId == items.id){
                                                if(eles.type==7){
                                                    ...
                                                    // else if(items.id == 111){
                                                    //     if(!that.form.skipTypeBanner1){
                                                    //         linkSkip = null;
                                                    //     }else{
                                                    //         linkSkip.linkType = that.form.skipTypeBanner1;
                                                    //         linkSkip.linkId = that.skipDates12_1.linkId;
                                                    //         linkSkip.linkUrl = that.skipDates12_1.linkUrl;
                                                    //         linkSkip.linkableButtonPageList = [
                                                    //             {
                                                    //                 "cmsPageId":that.skipDates12_1.cmsPagePcId,
                                                    //                 "clientType":5
                                                    //             },
                                                    //             {
                                                    //                 "cmsPageId":that.skipDates12_1.cmsPageMId,
                                                    //                 "clientType":6
                                                    //             }
                                                    //         ];
                                                    //         linkSkip.extParam = [
                                                    //             {
                                                    //                 "name":"extParam1",
                                                    //                 "value":that.skipDates12_1.linkdate1
                                                    //             },
                                                    //             {
                                                    //                 "name":"extParam2",
                                                    //                 "value":that.skipDates12_1.linkdate2
                                                    //             },
                                                    //             {
                                                    //                 "name":"extParam3",
                                                    //                 "value":that.skipDates12_1.linkdate3
                                                    //             }
                                                    //         ];
                                                    //     }
                                                    // }else if(items.id == 120){
                                                    //     if(!that.form.skipTypeBanner2){
                                                    //         linkSkip = null;
                                                    //     }else{
                                                    //         linkSkip.linkType = that.form.skipTypeBanner2;
                                                    //         linkSkip.linkId = that.skipDates12_2.linkId;
                                                    //         linkSkip.linkUrl = that.skipDates12_2.linkUrl;
                                                    //         linkSkip.linkableButtonPageList = [
                                                    //             {
                                                    //                 "cmsPageId":that.skipDates12_2.cmsPagePcId,
                                                    //                 "clientType":5
                                                    //             },
                                                    //             {
                                                    //                 "cmsPageId":that.skipDates12_2.cmsPageMId,
                                                    //                 "clientType":6
                                                    //             }
                                                    //         ];
                                                    //         linkSkip.extParam = [
                                                    //             {
                                                    //                 "name":"extParam1",
                                                    //                 "value":that.skipDates12_2.linkdate1
                                                    //             },
                                                    //             {
                                                    //                 "name":"extParam2",
                                                    //                 "value":that.skipDates12_2.linkdate2
                                                    //             },
                                                    //             {
                                                    //                 "name":"extParam3",
                                                    //                 "value":that.skipDates12_2.linkdate3
                                                    //             }
                                                    //         ];
                                                    //     }
                                                    // }else if(items.id == 129){
                                                    //     if(!that.form.skipTypeBanner3){
                                                    //         linkSkip = null;
                                                    //     }else{
                                                    //         linkSkip.linkType = that.form.skipTypeBanner3;
                                                    //         linkSkip.linkId = that.skipDates12_3.linkId;
                                                    //         linkSkip.linkUrl = that.skipDates12_3.linkUrl;
                                                    //         linkSkip.linkableButtonPageList = [
                                                    //             {
                                                    //                 "cmsPageId":that.skipDates12_3.cmsPagePcId,
                                                    //                 "clientType":5
                                                    //             },
                                                    //             {
                                                    //                 "cmsPageId":that.skipDates12_3.cmsPageMId,
                                                    //                 "clientType":6
                                                    //             }
                                                    //         ];
                                                    //         linkSkip.extParam = [
                                                    //             {
                                                    //                 "name":"extParam1",
                                                    //                 "value":that.skipDates12_3.linkdate1
                                                    //             },
                                                    //             {
                                                    //                 "name":"extParam2",
                                                    //                 "value":that.skipDates12_3.linkdate2
                                                    //             },
                                                    //             {
                                                    //                 "name":"extParam3",
                                                    //                 "value":that.skipDates12_3.linkdate3
                                                    //             }
                                                    //         ];
                                                    //     }
                                                    // };
                            ...
                            console.log(that.exampleForm.bannerIds);
                            eleConArray.push({
                                elementId:info.elementId,
                                elementSort:info.elementSort,
                ...
                console.log(that.form.tempFormBasic);
                $.each(that.form.tempFormBasic,function(id,info){
                    // if(info.value && info.id!=21 && info.id!=22 && info.id!=23 && info.id!=24 && info.id!=25 && info.id!=26 && info.id!=27){
                    if(info.value && info.id!=21 && info.id!=22 && info.id!=23 && info.id!=24 && info.id!=25 && info.id!=26 && info.id!=27 && info.id!=16){
                        ...
                        console.log(that.form.skipTypeTitle);
                        if(that.form.skipTypeTitle){
                            let linkSkip = new Object();
                ...
                console.log(obj);
                that.updateCmsPageByIdWithTx(obj);
            }
