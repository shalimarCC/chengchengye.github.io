<template>
    <div class="goodsList">
        ...
        <div class="goods" ref="goods_list" :style="goodsHeight" v-if="goodsType || goodsList.length > 0">
            <ul
            class="list1"
            v-if="listType"
        ...
        <!--<div class="error" v-else :style="'height:'+listHeight+'px;'">-->
        <div class="error" v-else :style="goodsHeight">
...
<script>
    ...
    export default{
        ...
        mounted() {
            ...
            this.goodsStyle.top = this.$refs.goods_list.getBoundingClientRect().top+'px';
            if(this.categoryType ==1){
              this.goodsHeight.height = this.listHeight+'px';
            }
